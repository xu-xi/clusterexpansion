...
def Main(ArgList):
    parser=argparse.ArgumentParser(description='plot results of cluster expansion for the given property. Please be careful about the option -e',
    ...
    parser.add_argument('-f',dest='filetype',default='png',help="any filetype supported by matplotlib")
    parser.add_argument('-t',dest='title',type=str,default='',help="the title of the plot of ECI")
    parser.add_argument('-o',dest='order',type=int,default=1,help="plot ECI from the order of clusters. The default value is 1 since the ECI of null cluster is just a shift")
